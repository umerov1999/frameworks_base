...
public class StatusBar extends SystemUI implements DemoMode,
    ...
    protected void makeStatusBarView() {
        ...
        filter.addAction(NitrogenUtils.ACTION_DISMISS_KEYGUARD);
    ...
    private final BroadcastReceiver mBroadcastReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            else if (NitrogenUtils.ACTION_DISMISS_KEYGUARD.equals(action)) {
                if (intent.hasExtra(NitrogenUtils.DISMISS_KEYGUARD_EXTRA_INTENT)) {
                    Intent launchIntent = (Intent) intent.getParcelableExtra(NitrogenUtils.DISMISS_KEYGUARD_EXTRA_INTENT);
    ...
    protected void updateTheme() {
        ...
        if (isUsingDarkTheme() != useDarkTheme) {
                try {
                    mOverlayManager.setEnabled("com.android.system.theme.dark.pixen",
                            useDarkTheme, mLockscreenUserManager.getCurrentUserId());
                    mOverlayManager.setEnabled("com.android.systemui.theme.dark.pixen",
                            useDarkTheme, mLockscreenUserManager.getCurrentUserId());
                    mOverlayManager.setEnabled("com.android.settings.theme.dark.pixen",
                            useDarkTheme, mLockscreenUserManager.getCurrentUserId());
                    mOverlayManager.setEnabled("com.android.gboard.theme.dark.pixen",
                            useDarkTheme, mLockscreenUserManager.getCurrentUserId());
                    // Check for black and white accent so we don't end up
                    // with white on white or black on black
                    unfuckBlackWhiteAccent();
        ...
        if (isUsingBlackTheme() != useBlackTheme) {
                try {
                    mOverlayManager.setEnabled("com.android.system.theme.black.pixen",
                            useBlackTheme, mLockscreenUserManager.getCurrentUserId());
                    mOverlayManager.setEnabled("com.android.systemui.theme.black.pixen",
                            useBlackTheme, mLockscreenUserManager.getCurrentUserId());
                    mOverlayManager.setEnabled("com.android.settings.theme.black.pixen",
                            useBlackTheme, mLockscreenUserManager.getCurrentUserId());
